                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <FadeIn delay={0.3}>
                            <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
                                Trusted orthopedic surgeon in Attibele & HSR Layout, Bengaluru — specializing in arthroscopy, sports injuries, joint replacement, and compassionate, evidence-based care.
                            </p>
                        </FadeIn>
